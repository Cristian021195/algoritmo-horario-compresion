import data from "./exprebus-38-sabados-ns.json" assert { type: 'json' };
...
const frecuencias = [
//posiblemente donde haya celda *, no evaluar, o cargar como frecuencia 0, en el indice correspondiente.
    {   frecuencia: 30, // en minutos
        indices: [1,2,3,8,9,10]
    },
    {   
        frecuencia: 40, indices: [4,5]
    },
    {
        frecuencia: 5, indices: [6,7]
    }
];
